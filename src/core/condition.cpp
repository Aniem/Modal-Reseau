...
namespace Modal
{
    ...
    void Condition::wait() {
        ...
        MODAL_ASSERT(cond_wait_status == 0);
    }
    ...
    bool Condition::timedWait(int seconds, int nanoseconds) {
        ...
        MODAL_ASSERT(cond_timedwait_status == 0 || cond_timedwait_status == ETIMEDOUT);
    ...
    void Condition::notify() {
        ...
        MODAL_ASSERT(cond_signal_status == 0);
    }

    void Condition::notifyAll() {
        int cond_broadcast_status = pthread_cond_broadcast(&(this->cond));
        MODAL_ASSERT(cond_broadcast_status == 0);
    }
